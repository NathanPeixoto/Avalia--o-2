            ...
            if (opcao == 1) {
                ...
                for(Produto p : produtos){
                    if(p.getCodigo().equals(codigo)){
                        System.out.println("\nO código digítado já foi utilizado no produto " + p.getNome());
                        toggler = true;
                        in.nextLine();
                    }
                }
                ...
                if(toggler == false){
                    System.out.println("\nDigíte o valor do produto (Vírgula para separar centavos):");
                    valor = in.nextDouble();
                ...
                if(toggler == false){
                    for(Produto p: produtos){
                        System.out.printf("Código: %s - Nome: %s - Valor Unitário: %s - Quantidade em estoque: %s\n", p.getCodigo(),p.getNome(),p.getValor(),p.getQuantidadeEmEstoque());
                    }
